...
class APIEntryPointApi(object):
    ...
    def retrieve_api_resources(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.retrieve_api_resources(async_req=True)
        >>> result = thread.get()
    ...
    def retrieve_api_resources_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.retrieve_api_resources_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(APIEntryPoint, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
