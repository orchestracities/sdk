...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self, host="https://api.s.orchestracities.com/timeseries",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("ngsi_timeseries_v2")
            ...
            'ApiKeyAuth':
                {
                    ...
                    'value': self.get_api_key_with_prefix('X-Gravitee-Api-Key')
                },
            'BearerAuth':
                {
                    'type': 'bearer',
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://api.s.orchestracities.com/timeseries",
