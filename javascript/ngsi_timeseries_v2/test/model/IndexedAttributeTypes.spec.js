...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgsiTimeseriesV2.IndexedAttributeTypes();
  });
  ...
  describe('IndexedAttributeTypes', function() {
    it('should create an instance of IndexedAttributeTypes', function() {
      // uncomment below and update the code to test IndexedAttributeTypes
      //var instane = new NgsiTimeseriesV2.IndexedAttributeTypes();
      //expect(instance).to.be.a(NgsiTimeseriesV2.IndexedAttributeTypes);
    });
