...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgsiTimeseriesV2.IndexedEntityTypeAttribute();
  });
  ...
  describe('IndexedEntityTypeAttribute', function() {
    it('should create an instance of IndexedEntityTypeAttribute', function() {
      // uncomment below and update the code to test IndexedEntityTypeAttribute
      //var instane = new NgsiTimeseriesV2.IndexedEntityTypeAttribute();
      //expect(instance).to.be.a(NgsiTimeseriesV2.IndexedEntityTypeAttribute);
    });
