...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new NgsiV2.BatchUpdate();
  });
  ...
  describe('BatchUpdate', function() {
    it('should create an instance of BatchUpdate', function() {
      // uncomment below and update the code to test BatchUpdate
      //var instane = new NgsiV2.BatchUpdate();
      //expect(instance).to.be.a(NgsiV2.BatchUpdate);
    });
