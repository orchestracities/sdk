 ...
 *
 *
 * NOTE: We modified the `ApiClient.js` auto-generated so we have to exclude
 * it from code generation.
 * In fact, we had to suppress the content type header in GET requests
 * to avoid API errors.
 */
...
class ApiClient {
  constructor() {
     ...
     * @type {String}
     * @default https://api.s.orchestracities.com/context/v2
     */
    this.basePath = 'https://api.s.orchestracities.com/context/v2'.replace(
      /\/+$/,
      ''
    );
    ...
    this.authentications = {
      ApiKeyAuth: { type: 'apiKey', in: 'header', name: 'X-Gravitee-Api-Key' },
